...
public class GestionarLogin {
	...
	public GestionarLogin(ConexionMySQL conx) {
		unUsuario = new Usuario();
		nuevaConexion = conx;
		connection = conx.obtenerConexion();
	}
	
//	Busca al usuario correspondiente para el login
	public Usuario buscarUsuario(String correo,String contrasenia) {
		String consulta = "SELECT id, nombre, correo,contrasenia, idTipoUsuario  FROM usuarios where correo='"+correo+"' AND contrasenia='"+contrasenia+"'";
		try {
